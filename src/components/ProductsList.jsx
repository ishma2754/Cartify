        ...
        {products.map((product) => {
          ...
          return (
            <Link to={`/products/${id}`} key={id} className="block mb-4">
              <div className="flex items-start gap-3 p-3 bg-white shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-300 dark:bg-gray-900 dark:border dark:border-gray-100 dark:shadow-sm dark:shadow-gray-100 dark:hover:bg-gray-800">
                ...
                <div className="flex-1 flex-col gap-2">
                  <h1 className="text-sm font-bold dark:text-gray-100 mb-4">
                    {title}
                  </h1>
